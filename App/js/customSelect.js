    ...
    */
    ...
    module.directive('customSelect', ['$parse', '$compile', '$timeout', '$q', 'customSelectDefaults', function($parse, $compile, $timeout, $q, baseOptions) {
        ...
        return {
            ...
            replace: false,
            //template: "",
            //controller: function () { alert('controller');},
                    ...
                    pre: function preLink(scope, elem, attrs, controller) {
                        ...
                        '<div class="dropdown-menu">' +
                            '<div stop-propagation="click" class="custom-select-search">' +
                                '<input type="text"  autocomplete="off" ng-model="searchTerm" />' +
                            '</div>' +
                            '<ul role="menu">' +
                        ...
                        function getOptions() {
                            attrs.customSelectOptions = { displayText: 'suresh' };
                        ...
                        //Set Scope variableS and methodS 
